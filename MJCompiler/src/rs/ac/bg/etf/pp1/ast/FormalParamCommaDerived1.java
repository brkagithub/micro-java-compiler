...
public class FormalParamCommaDerived1 extends FormalParamComma {

    private FormalParamDecl FormalParamDecl;

    public FormalParamCommaDerived1 (FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormalParamCommaDerived1(\n");
