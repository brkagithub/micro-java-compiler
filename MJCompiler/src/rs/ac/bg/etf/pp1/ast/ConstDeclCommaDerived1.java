...
public class ConstDeclCommaDerived1 extends ConstDeclComma {

    private ConstDeclaration ConstDeclaration;

    public ConstDeclCommaDerived1 (ConstDeclaration ConstDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstDeclCommaDerived1(\n");
